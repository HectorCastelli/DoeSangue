...
<body>
	<div data-role="page" id="main">
		...
		<div data-role="content">
			<form method="get" action="editar_function.php">
			<?php
			//echo $_GET['i'];
			//conectar ao SQL
			if (mysql_connect($server,$username,$password)) {
				...
				if (mysql_select_db($database)) {
					...
					$query = mysql_query('SELECT id, nome, dia, num_vagas, hora_inicio, hora_final, nome, gestor FROM campanhas_gestores WHERE gestor = '.$_GET['f'].' AND ativa = 1');						
					}
					if ($query == "") {
						//nulo
